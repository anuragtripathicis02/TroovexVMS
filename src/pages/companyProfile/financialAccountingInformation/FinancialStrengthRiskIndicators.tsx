...
const FinancialStrengthRiskIndicators = () => {
    return (
        <div className='row pt-0'>
            ...
            <div className='col-md-12 mb-4'>
                <div className="list-card-box p-0  m-0 bg-transparent border-0">
                    <FileUploadItem title="Insurance Policy" required />
                </div>
            </div>
            <div className='col-md-12 mb-4'>
                <Link to="" className="d-inline-flex align-items-center gap-1 p-0 btn-grey-text border-0 bg-transparent">
