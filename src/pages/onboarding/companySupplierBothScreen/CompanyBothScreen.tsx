...
import EmailVerificationModal from "../../../common/modalComponent/EmailVerificationModal";
              ...
              <div className="role-sec d-flex flex-column header-clc-height">
                <div className="top-box-role">
                  <div className="mb-48 text-center">
                    ...
                    <p className="mb-0">
                      Let’s getting you started by creating your account in
                      throovex
                    </p>
                  </div>
                  <Form>
                    <div className="row">
                      <div className="col-lg-6 mb-4">
                        ...
                        >
                          <Form.Control
                            type="text"
                            placeholder="Algeria Infra & Argo Co."
                          />
                        </FloatingLabel>
                      </div>
                      <div className="col-lg-6 mb-4">
                ...
                <div className="bottom-box-role mt-auto pb-4">
                  <div className="container text-center">
                    <Button
                      type="button"
                      className="btn-outline fill-btn gap-2 mb-32 "
                      onClick={handleEmailVerification}
                    >
                      Sign me up as Company
                    </Button>
                    <div className="role-text">
                      {" "}
                      By continuing further you are agreed to our{" "}
